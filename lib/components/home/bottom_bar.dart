                ...
                children: [
                    ...
                    children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: SvgPicture.asset("assets/icons/email.svg",
                                color:primaryColor ,
                                height:Responsive.isMobile(context)?15:30,width: Responsive.isMobile(context)?15:30),
                          ),
                          Text("manishsaini97285@gmail.com",style:Responsive.isMobile(context)?
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text("+91-8307149104",style:Responsive.isMobile(context)?
                          const TextStyle(color: primaryColor,fontWeight: FontWeight.w500,fontSize: 10):
                          const TextStyle(color: primaryColor,fontWeight: FontWeight.w700)
                          ),
                        ],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("House 504 ,Phase 4, Mohali",style:Responsive.isMobile(context)?
                      const TextStyle(color: primaryColor,fontWeight: FontWeight.w500,fontSize: 10):
                      const TextStyle(color: primaryColor,fontWeight: FontWeight.w700)
                      ),
                    ],
